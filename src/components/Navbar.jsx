...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white/95 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-50 relative">
        ...
        <div className="hidden md:flex items-center gap-12 font-semibold">
          {navLinks.map((link) => (
            <NavLink 
              ...
              to={link.path} 
              className={({isActive}) => 
                `relative py-1 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:bg-[#f42619] after:transition-all after:duration-300 ${
                  isActive ? "text-[#f42619] after:w-full" : "text-[#555555] hover:text-[#f42619] after:w-0 hover:after:w-full"
                }`
              }
            >
              {link.name}
      ...
      <div 
        className={`md:hidden absolute top-full left-0 w-full bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-xl transition-all duration-300 ease-out z-40 ${
            ...
            <NavLink 
              ...
              className={({isActive}) => 
                `px-4 py-3 rounded-xl transition-all duration-200 ${
                  isActive ? "bg-[#f42619]/10 text-[#f42619]" : "text-[#555555] hover:bg-gray-50 hover:text-[#f42619]"
                }`
              }
            >
              {link.name}
